...
# Creaing Compute Network for the project
...
# Creating a Subnet for Web Application
...
# Creating a Subnetwork for Database Instance although we are not using it for now 
...
# Creating a Web Internet Route for Web Application
...
# Creating a VPC Access Connector which will be used by Cloud Function to Publish Messages to PubSub from Web Application 
